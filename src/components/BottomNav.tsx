  ...
  return (
    <>
      ...
      >
        ...
        {/* Secondary — Feed + Rewards & Earnings (desktop sidebar only) */}
        <Box sx={{ px: 1, pb: 1, borderTop: '1px solid', borderColor: 'divider', pt: 1 }}>
          {[
            { href: '/timeline', label: 'Feed',              icon: Rss    },
            { href: '/rewards',  label: 'Rewards & Earnings', icon: Wallet },
